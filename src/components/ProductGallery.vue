            ...
            <div class="product-info" :id="'2215'+product.id" v-show="isProductItemShow">
                ...
                <div class="product-info__photos">
                    ...
                    <div class="product-info__links">
                        <button class="product-info__links-price" @click="goToProductTop()">
                            <span class="product-info__links-price_value">{{ product.price }} р.</span> 
                            <span class="product-info__links-price_plus">+</span>
                        </button>
                        <button class="icon product-info__links-share"
                            v-clipboard:copy="product.vk"
                            v-clipboard:success="copySucceeded"
                        >
                            <img src="@/assets/icons/share.svg" alt="share">
                        </button>
                        <button class="icon favorite product-info__links-favorite">
                ...
                <button class="product-info__close icon close" @click="closeProduct()">
